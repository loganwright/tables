...
struct GeneralCryptor {
    static let shared: GeneralCryptor = .init()
...
struct Files {
    ...
    init(folder: String, encrypted: Bool) {
    ...
    func write<E: Encodable>(filename: String, _ ob: E, pretty: Bool = false) throws {
    ...
    func read<D: Decodable>(filename: String, as: D.Type = D.self) throws -> D? {
    ...
    func _unsafe_read(filename: String) throws -> Data? {
        let fileurl = dir.appendingPathComponent(filename, isDirectory: false)
    ...
    func readAll<D: Decodable>(as: D.Type = D.self) throws -> [D] {
    ...
    func allFiles(createdBefore: Date) throws -> [String] {
